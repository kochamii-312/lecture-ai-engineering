...
def get_sentiment_label(comment):
    ...
    negative_keywords = ['とまど', '戸惑', 'にく', 'づら', 'ずら','辛い','もうちょっと','ほしかった', 'もらいたかった','たら嬉しかった','であるとよかった','ほうがいい', '方がいい', 'ほうが良い','方が良い', '方がよかった', 'ほうがよかった', 'であるとありがたかった', 'であると有難かった', '方がありがたかった', 'ほうがありがたかった', '方が有難かった', 'ほうが有難かった','わかりにくい', 'わかりづらい', '難しい','難しく', '難しすぎる', '難しすぎた', '難しかった', 'わからなかった', 'わからない', 'わかりません', '分からなかった', '分からない', '分かりません', '残念', 'できなかった','できない', 'できません', '出来ない','出来ません', 'いただけるとありがたい', '期待します']
