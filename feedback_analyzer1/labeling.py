...
def get_sentiment_label(comment):
    ...
    positive_keywords = ['良かった', 'よかった', '良い', 'よい', 'ありがとうござい', '有難うござい', 'ありがた', '有り難','やす', '楽しかった', '楽しい', '面白かった', '面白い', '素晴らしい', '素晴らしかった', '最高','嬉しい', '嬉しかった', '感謝', 'できた', '出来た', '良く', '助か', '満足','楽しみ', '丁寧', '親切', '役に立', '役立']
    negative_keywords = ['とまど', '戸惑', 'にく', 'づら', 'ずら','辛い','もうちょっと','ほしかった', 'もらいたかった','たら嬉しかった','ればよ','れば良','であるとよかった','ほうがいい', '方がいい', 'ほうが良い','方が良い', '方がよかった', 'ほうがよかった', 'であるとありがたかった', 'であると有難かった', '方がありがたかった', 'ほうがありがたかった', '方が有難かった', 'ほうが有難かった','わかりにくい', 'わかりづらい', '難しい','難しく', '難しすぎる', '難しすぎた', '難しかった', 'わからなかった', 'わからない', 'わかりません', '分からなかった', '分からない', '分かりません', '残念', 'できなかった','できない', 'できません', '出来ない','出来ません', 'いただけるとありがたい', '期待します']
