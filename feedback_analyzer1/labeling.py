...
def get_sentiment_label(comment):
    ...
    positive_keywords = ['良かった', 'よかった', '良い', 'よい', 'ありがとうござい', '有難うござい', 'ありがた', '有り難','やす', '楽しかった', '楽しい', '面白かった', '面白い', '素晴らしい', '素晴らしかった', '最高','嬉しい', '嬉しかった', '感謝', 'できた', '出来た', 'よく', '良く', '助か', '満足']
    negative_keywords = ['とまど', '戸惑', 'にく', 'づら', 'ずら','もうちょっと', 'であるとよかった', '方がよかった', 'ほうがよかった', 'であるとありがたかった', 'であると有難かった', '方がありがたかった', 'ほうがありがたかった', '方が有難かった', 'ほうが有難かった','わかりにくい', 'わかりづらい', '難しい','難しく', '難しすぎる', '難しすぎた', '難しかった', 'わからなかった', 'わからない', '分からなかった', '分からない']
    ...
    for pos_keyword in positive_keywords:
        if pos_keyword == 'よかった' and ('であるとよかった' or '方がよかった' or 'ほうがよかった') in text_lower:
            ...
            continue
        elif pos_keyword == 'ありがたい' and ('であるとありがたい' or '方がありがたい' or 'ほうがありがたい') in text_lower:
            continue
